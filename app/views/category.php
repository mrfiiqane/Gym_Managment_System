...
<main class="space-y-4 animate-fadeIn  dark:bg-darkPanel w-87.5 md:w-full rounded-3xl shadow-lg border border-primary/5">
  ...
  <header class="flex items-center justify-between p-2 backdrop-blur-md border-b border-primary/5">
    <div class="flex items-center gap-4">
      <h1 class="text-3xl font-black text-slate-800 dark:text-white tracking-tight">All Category's Management</h1>
    </div>
  </header>
  <div class="bg-white dark:bg-darkPanel rounded-3xl shadow-lg border border-primary/5 overflow-hidden">
      ...
      <div class="p-4 border-b border-primary/5 flex justify-between items-center">
        <div class="flex items-center gap-2">
          ...
          <p class="text-sm font-medium text-slate-500 dark:text-slate-400">
            Total category's: <span id="totalCount" class="font-bold text-slate-800 dark:text-white">0</span>
          </p>
        </div>
    ...
    <div class="p-6 border-t border-slate-50 dark:border-white/5 flex items-center justify-between bg-slate-50/50 dark:bg-white/2">
      <p id="paginationInfo" class="text-xs font-medium text-slate-500 dark:text-slate-400">Showing 0 of 0 categorys</p>
      <div class="flex items-center gap-2">
...
<div id="modal" class="fixed inset-0 bg-black/40 hidden items-center justify-center z-50 backdrop-blur-sm transition-all">
  <div class="bg-white dark:bg-darkPanel p-8 rounded-[2rem] h-8/10 max-w-[580px]  relative shadow-2xl border border-primary/10 m-4">
    ...
    <div class="flex justify-between items-center mb-8">
      <div>
        <h3 id="modalTitle" class="text-2xl font-black text-slate-800 dark:text-white">Add New category</h3>
        <p class="text-xs text-slate-400 font-medium mt-1 uppercase tracking-widest">category Information System</p>
      </div>
    ...
    <form id="category_form" class="space-y-4" method="post">
      ...
      <div class="space-y-1.5">
        <label class="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">icon</label>
        <input type="text" name="icon" id="icon" placeholder="E.g. Home" required
          class="w-full p-3.5 bg-slate-50 dark:bg-white/5 border border-transparent focus:border-primary/30 focus:bg-white dark:focus:bg-darkPanel rounded-2xl outline-none transition-all dark:text-white shadow-inner">
      </div>
      <div class="space-y-1.5">
        <label class="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Select Type</label>
        <select name="role" id="role" required
          class="w-full p-3.5 bg-slate-50 dark:bg-white/5 border border-transparent focus:border-primary/30 focus:bg-white dark:focus:bg-darkPanel rounded-2xl outline-none transition-all dark:text-white shadow-inner appearance-none">
          <option value="" disabled selected>Select a Category...</option>
          <option value="Dashboard" class="dark:bg-slate-800">Dashboard</option>
          <!-- <option value="Academic" class="dark:bg-slate-800">Academic Management</option> -->
          <option value="Reports" class="dark:bg-slate-800">Reports & Analytics</option>
          <option value="Finance" class="dark:bg-slate-800">Finance</option>
          <option value="News" class="dark:bg-slate-800">News</option>
          <option value="SystemManagement" class="dark:bg-slate-800">System Management</option>
          <option value="SupportLegal" class="dark:bg-slate-800">Support & Legal</option>
        </select>
