...
<main class="flex-1 overflow-y-auto bg-slate-50/50 dark:bg-darkBody transition-all duration-300">
  ...
  <div
    class="bg-white dark:bg-darkPanel rounded-4xl border border-primary/5 shadow-xl shadow-primary/5 overflow-hidden">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 p-10">
      ...
      <div class="space-y-6">
        ...
        <div class="flex gap-3">
          <a href="#"
            class="w-9 h-9 rounded-lg bg-slate-100 dark:bg-white/5 flex items-center justify-center text-slate-500 hover:bg-primary hover:text-white transition-all duration-300">
      ...
      <div>
        ...
        <ul class="space-y-4">
          <li><a href="#"
              class="text-sm text-slate-500 dark:text-slate-400 hover:text-primary transition-colors flex items-center gap-2">
              Dashboard</a></li>
          <li><a href="#"
              class="text-sm text-slate-500 dark:text-slate-400 hover:text-primary transition-colors flex items-center gap-2">
              All Students</a></li>
      ...
      <div>
        ...
        <ul class="space-y-4">
          ...
          <li class="flex items-center gap-3">
            ...
            <span class="text-sm text-slate-500 dark:text-slate-400">support@studentms.com</span>
          </li>
          <li class="flex items-center gap-3">
            <span class="material-symbols-outlined text-primary text-lg size-6 animate-bounce">location_on</span>
            <span class="text-sm text-slate-500 dark:text-slate-400">Mogadishu, Somalia</span>
          </li>
        </ul>
      </div>
      ...
      <div class="bg-primary/5 rounded-2xl p-6 border border-primary/10">
        ...
        <p class="text-[11px] text-slate-500 dark:text-slate-400 mb-4">Wixii cilad ah oo aad isku aragto fadlan la
          xiriir kooxda farsamada.</p>
        <button
          class="w-full py-2 bg-white dark:bg-white/5 text-primary text-xs font-bold rounded-lg border border-primary/20 hover:bg-primary hover:text-white transition-all shadow-sm">
          Get Support
        </button>
      </div>
