const api_url = window.BASE_URL + "api/users/users.php";
...
function load_user_menus() {
  $.ajax({
    method: "POST",
    dataType: "JSON",
    url: window.BASE_URL + "api/user_authorities.php",
    ...
    error: function () {
      $("#user_menu").html(
        `<p class="text-xs text-rose-400 px-4">Failed to load menus.</p>`,
      );
    },
  });
}
